...
import com.raghul.asset_tracker.adapter.NotificationListAdapter
...
import com.raghul.asset_tracker.viewmodel.NotificationViewModel
...
class NotificationFragment : Fragment() {
    ...
    private lateinit var notificationListView:RecyclerView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        notificationListView = view.findViewById(R.id.notification_lists)
        notificationAdapter = NotificationListAdapter()
        notificationListView.adapter = notificationAdapter
        ViewModelProviders.of(this).get(NotificationViewModel::class.java).getAllNotifications()
